...
/**
 * Componente EditProduct per la modifica dei prodotti esistenti nell'inventario
...
const EditProduct = () => {
  ...
  useEffect(() => {
    ...
    if (product) {
      ...
      // Prodotto non trovato, reindirizza alla pagina dell'inventario
      navigate(basePath);
    }
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    // Qui andrebbe implementata la logica per aggiornare il prodotto
    console.log('Prodotto da aggiornare:', formData);
